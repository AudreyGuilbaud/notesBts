...
<div class="titrePartie">
    <input name="partie_e4" id="partie_e4" class="inputNoteGen" type="text" readonly>
    <label for="partie_e4">&nbsp;&nbsp;E4 : Conception et maintenance de solutions informatiques</label>

</div>
<br>
<div class="partieNotes">
    <input name="txt_e4" id="txt_e4" class="inputNote" type="text">
...
<br>
<div class="partieNotes">
    <input name="txt_e5" id="txt_e5" class="inputNote" type="text">
...
<br>
<div class="partieNotes">
    <input name="txt_e6" id="txt_e6" class="inputNote" type="text">
    <label for="txt_e6">&nbsp;&nbsp;Parcours de professionnalisation : </label>   
</div>
